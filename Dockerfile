...
RUN set -x && \
    ...
    sudo apt-get -y install wget bzip2 gcc make libssl-dev libgcrypt11-dev libpam0g-dev libwrap0-dev libdb-dev libavahi-client-dev libacl1-dev libldap2-dev && \
    cd /usr/local/src && \
